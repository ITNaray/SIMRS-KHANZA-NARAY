...
public class DlgBarang extends javax.swing.JDialog {
    ...
    public void keyReleased(java.awt.event.KeyEvent evt) {
        try {
            double hrgDasar = Double.parseDouble(dasar.getText());
            
            double hargaAkhir = hrgDasar * 1.11 * 1.40;
            double hargaKaryawan = hrgDasar * 1.11 * 1.40 * 0.90;

            double hrgBeli = hrgDasar;
         
            beli.setText(String.format("%.0f", hrgBeli));
            ralan.setText(String.format("%.0f", hargaAkhir));
            kelas1.setText(String.format("%.0f", hargaAkhir));
            kelas2.setText(String.format("%.0f", hargaAkhir));
            kelas3.setText(String.format("%.0f", hargaAkhir));
            utama.setText(String.format("%.0f", hargaAkhir));
            kelasvip.setText(String.format("%.0f", hargaAkhir));
            kelasvvip.setText(String.format("%.0f", hargaAkhir));
            beliluar.setText(String.format("%.0f", hargaAkhir));
            jualbebas.setText(String.format("%.0f", hargaAkhir));
            karyawan.setText(String.format("%.0f", hargaKaryawan));
