...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnRiwayat = new widget.Button(); // tombol riwayat pasien
    ...
    // increased preferred size so all input fields fit comfortably (further enlarged)
    PanelInput.setPreferredSize(new java.awt.Dimension(1140, 420));
    ...
    // make panelGlass12 wide enough to host expanded textareas (further enlarged)
    panelGlass12.setPreferredSize(new java.awt.Dimension(1140, 420));
    ...
    jLabel25.setBounds(450, 10, 90, 23);
        ...
        jLabel20.setBounds(130, 262, 90, 23);
    ...
    TPemeriksaan.setColumns(36);
    TPemeriksaan.setRows(7);
    ...
    // move vitals area down so textareas (Subjek/Objek) don't overlap
    TSuhu.setBounds(73, 230, 55, 23);
    ...
    TTensi.setBounds(223, 230, 74, 23);
    ...
    TTinggi.setBounds(73, 262, 55, 23);
    ...
    TRespirasi.setBounds(223, 262, 55, 23);
    ...
    TBerat.setBounds(378, 230, 55, 23);
    ...
    TPenilaian.setColumns(36);
    TPenilaian.setRows(7);
    ...
    scrollPane6.setBounds(660, 150, 520, 90);

    jLabel29.setText("Kesadaran :");
    jLabel29.setName("jLabel29"); 
    panelGlass12.add(jLabel29);
    // move Kesadaran down to avoid overlap with textareas
    jLabel29.setBounds(234, 295, 70, 23);
    ...
    cmbKesadaran.setBounds(307, 295, 126, 23);
    ...
    scrollPane7.setBounds(660, 250, 520, 60);
        ...
        jLabel54.setBounds(0, 295, 70, 23);
    ...
    scrollPane8.setBounds(660, 320, 520, 60);
        ...
        BtnInputObat.setText("Input Obat & BHP dari Depo");
...
private void BtnResumeActionPerformed(java.awt.event.ActionEvent evt) {                                          
    ...
    this.setCursor(Cursor.getDefaultCursor());
        ...
        if(jml > 0){
            ...
            BtnResume.setGlassColor(new java.awt.Color(255,0,0)); // merah muda
            BtnResume.setRoundRect(true);
        }
    }
    ...
    */
    ...
    private void isForm(){
        if(ChkInput.isSelected()==true){
            ...
            // increase visible form height to match enlarged inputs
            ...
            case 3:
                if((!TKeluhan.getText().trim().equals(""))||(!TPemeriksaan.getText().trim().equals(""))||(!TSuhu.getText().trim().equals(""))||
                    ...
                    if(KdPeg.getText().trim().equals("")||TPegawai.getText().trim().equals("")){
                        ...
                        Valid.textKosong(TKeluhan,"Subjektif pasien harus diisi...!!");
                    } else if(TPemeriksaan.getText().trim().equals("")) {
                        Valid.textKosong(TPemeriksaan,"Objektif pemeriksaan harus diisi...!!");
                    } else if(TPenilaian.getText().trim().equals("")) {
                        Valid.textKosong(TPenilaian,"Penilaian/Asesmen harus diisi...!!");
                    } else if(TindakLanjut.getText().trim().equals("")) {
                        Valid.textKosong(TindakLanjut,"Rencana Tindak Lanjut harus diisi...!!");
                    } 
                    else{
                        if(akses.getkode().equals("Admin Utama")){
