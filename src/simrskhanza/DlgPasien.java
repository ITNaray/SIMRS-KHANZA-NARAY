...
public class DlgPasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        CMbGd.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "A+","A-", "B+", "B-","AB+","AB-" , "O+","O-" }));
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-04-2025" }));
        ...
        DTPDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-04-2025" }));
