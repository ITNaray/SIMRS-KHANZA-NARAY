...
public final class RMDataCatatanKeseimbanganCairan extends javax.swing.JDialog {
    ...
    public RMDataCatatanKeseimbanganCairan(java.awt.Frame parent, boolean modal) {
        ...
        Infus.setDocument(new batasInput((byte)7).getOnlyAngka(Infus));
        Tranfusi.setDocument(new batasInput((byte)7).getOnlyAngka(Tranfusi));
        Minum.setDocument(new batasInput((byte)7).getOnlyAngka(Minum));
        Urine.setDocument(new batasInput((byte)7).getOnlyAngka(Urine));
        Drain.setDocument(new batasInput((byte)7).getOnlyAngka(Drain));
        NGT.setDocument(new batasInput((byte)7).getOnlyAngka(NGT));
        IWL.setDocument(new batasInput((byte)7).getOnlyAngka(IWL));
        Keseimbangan.setDocument(new batasInput((byte)7).getOnlyAngka(Keseimbangan));
